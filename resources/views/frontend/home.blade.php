...
<section class="main container">
    <div class="slide-show">
        <div class="container py-3">
            <div class="list-image">
                <img class="img-fluid" src="{{ asset('images/slider_1.webp')}}" class="img-fluid" alt="baner">
    ...
    <div class="product-list mb-3">
        <div class="product-title border-bottom">
            <div class="row">
                <div class="col-md-4">
                    <strong class="text-white bg-danger ">
                        ĐỒ CÔNG NGHỆ
                    </strong>

                </div>
                <div class="col-md-8 text-end">
                    Điện thoại - Máy tính bảng Phụ kiện - Thiết bị số Máy ảnh - Quay phim Điện gia dụng - Nhà bếp Laptop - Thiết bị IT
                </div>
            </div>
        </div>
    ...
    <div class="product-list mb-3">
        <div class="product-title border-bottom">
            <div class="row">
                ...
                <div class="col-md-8 text-end">
                    Thời trang nữ Thời trang nam Đồng hồ & Trang sức Giày dép nữ Giày dép nam
                </div>
            </div>
        </div>
        <div class="product-list-s py-3">
